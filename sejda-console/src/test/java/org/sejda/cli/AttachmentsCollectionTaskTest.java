...
public class AttachmentsCollectionTaskTest extends AbstractTaskTest {
    ...
    public void testInitialView_Default() {
        AttachmentsCollectionParameters parameters = defaultCommandLine().invokeSejdaConsole();
        assertEquals(InitialView.TILES, parameters.getInitialView());
    }

    @Test
    public void testInitialView_Initial() {
        AttachmentsCollectionParameters parameters = defaultCommandLine().with("-i", "details").invokeSejdaConsole();
        assertEquals(InitialView.DETAILS, parameters.getInitialView());
    }
}
