...
public class FileOutputTraitTest extends AbstractTaskTraitTest {
    ...
    public void positive() {
        AbstractParameters result = defaultCommandLine().with("-o", "./outputs/fileOutput.pdf").invokeSejdaConsole();
        assertOutputFile((SingleOutputDocumentParameter) result, new File("./outputs/fileOutput.pdf"));
    }
}
