...
public class DecryptConsoleTest extends BaseConsoleTest {
    ...
    public void testSourceFileNotFound() {
        assertConsoleOutputContains("decrypt --compressed --files input-doesntexist.pdf",
    ...
    @Test
    public void testPositiveSourceFileNoPassword() {
        DecryptParameters result = invokeConsoleAndReturnTaskParameters("decrypt --compressed --files inputs/input.pdf --o ./outputs");
    ...
    @Test
    public void testPositiveSourceFileWithPassword() {
        DecryptParameters result = invokeConsoleAndReturnTaskParameters("decrypt --compressed --files inputs/input-protected.pdf;secret123 --o ./outputs");
    ...
    @Test
    public void testPositiveBaseParameters() {
        DecryptParameters result = invokeConsoleAndReturnTaskParameters("decrypt --compressed --files inputs/input.pdf --o ./outputs");
        assertTrue(result.isCompressXref());
        assertEquals(result.getOutput().getOutputType(), OutputType.DIRECTORY_OUTPUT);
        assertEquals(((PdfDirectoryOutput) result.getOutput()).getFile(), new File("./outputs"));
