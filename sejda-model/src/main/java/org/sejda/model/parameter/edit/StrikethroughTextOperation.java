...
public class StrikethroughTextOperation {

    private int pageNumber;
    private Set<RectangularBox> boundingBoxes;
    private Color color;

    public StrikethroughTextOperation(int pageNumber, Set<RectangularBox> boundingBoxes, Color color) {
    ...
    public boolean equals(Object o) {
        ...
        StrikethroughTextOperation that = (StrikethroughTextOperation) o;
