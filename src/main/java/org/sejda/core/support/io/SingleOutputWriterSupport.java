 ...
 * generated by the task itself . An extending class can call the {@link SingleOutputSupport#flushSingleOutput(PopulatedFileOutput, PdfOutput, boolean)} to flush to the
 * output destination.
 * 
 * <pre>
 * {@code
