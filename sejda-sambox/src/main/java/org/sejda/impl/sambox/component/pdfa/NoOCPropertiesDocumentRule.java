 ...
 */
public class NoOCPropertiesDocumentRule extends BaseRule<PDDocument, TaskException> {

    public NoOCPropertiesDocumentRule(ConversionContext conversionContext) {
