...
public class ExtractByOutlineSamboxTaskTest extends BaseTaskTest<ExtractByOutlineParameters> {
    ...
    public void testSplitDeeperLevel() throws IOException {
        ...
        execute(parameters);
        testContext.assertOutputContainsFilenames("1_Creating Assemblies.pdf", "2_Using Profiles.pdf",
                ...
                "13_Online webdevelopment and automatic deployment with tomcat plugin.pdf").assertOutputSize(13);
    }
    ...
    @Override
    public Task<ExtractByOutlineParameters> getTask() {
        return new ExtractByOutlineTask();
    }
}
